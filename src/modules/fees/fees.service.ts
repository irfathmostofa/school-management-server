...
export class FeesService {
  ...
  async send_due_report_sms(req: any, res: any) {
  ...
  addFeesCollection(req: any, res: any) {
  const {
    student_id,
    fees_info,
    feesType,
  ...
  async addFeesCollectionForward(req: any, res: any) {
  const {
    student_id,
    fees_info,
    feesType,
  ...
  async addStudentExtraFacility(req: any, res: any) {
  const {
    student_id,
    facility_1,
    facility_2,
  ...
  async UpdateStudentExtraFacility(req: any, res: any) {
  const {
    student_id,
    facility_1,
    facility_2,
  ...
  fetchExtraFeeList(req: any, res: any) {
  const {
    Class,
    session,
    campus,
  ...
  getStudentExtraFacility(req: any, res: any) {
  const { student_id } = req.body;
  ...
  fetchExtraFeeInfoApprovel(req: any, res: any) {
  db.query("SELECT *FROM extra_facilities WHERE pstatus = 0", (err, result) => {
    res.json({ message: result });
  });
}

  UpdateExtraFeeInfoApprovel(req: any, res: any) {
  ...
  feesCollectionById(req: any, res: any) {
  const { student_id } = req.body;
  const query = `
    SELECT 
      fc.*, 
  ...
  getAllCollectedfees(req: any, res: any) {
  ...
  getAllfeesCollectioninfoWithStudent(req: any, res: any) {
  ...
  getFeesbymonth(req: any, res: any) {
...
//   const formattedMonth = `${year}-${monthNum}`; 
  ...
  getAllfeesCollectioninfo(req: any, res: any) {
  db.query("SELECT *FROM fees_collection", (err, result) => {
    res.json({ message: result });
  });
}

  testCalcFine(req: any, res: any) {
  ...
  feesCollectionApproval(req: any, res: any) {
  const sql = `
    SELECT 
      s.student_id,
      s.student_first_name,
  ...
  async process_payment(req: any, res: any) {
    const { studentId, paymentAmount, mode, account_id, paymentDate, compile } = req.body;
    const query = (sql, params) => {
        return new Promise((resolve, reject) => {
            db.query(sql, params, (err, result) => {
  ...
  feesCollectionDueBalance(req: any, res: any) {
  ...
  getAdvanceFeesStatus(req: any, res: any) {
  const { student_id } = req.body;
  db.query(
  ...
  updateFeesCollection(req: any, res: any) {
  const {
    id,
    payment_mode,
    payment_date,
  ...
  updateFeesCollectionNew(req: any, res: any) {
  const {
    ids, 
    studentId,
    payment_mode,
  ...
  updateFeesCollectionSingle(req: any, res: any) {
  const {
    id,
    studentId,
    payment_mode,
  ...
  approveFeesCollection(req: any, res: any) {
  const { id } = req.body;
  db.query(
    "UPDATE fees_collection SET ? WHERE id = ?",
    [{ status2: 0 }, id],
  ...
  deleteFeesCollection(req: any, res: any) {
   const { id } = req.body;
  ...
  deleteCollectedFees(req: any, res: any) {
  const { payment_id } = req.body;
  ...
  approveSingleFeesCollection(req: any, res: any) {
  ...
  UpdateFeeTypeById(req: any, res: any) {
  ...
  ApprovedFeeTypeById(req: any, res: any) {
  const { id, status } = req.body;
  db.query(
    "UPDATE feesType SET ? WHERE id = ?",
    [{ pstatus: status }, id],
  ...
  paymentRepicts(req: any, res: any) {
  const { student_id, start_date, end_date } = req.body;
  const currentDate = new Date().toISOString().split("T")[0];
  const start = start_date || currentDate;
  const end = end_date || currentDate;
  ...
  async v1_getFeeInfo(req: any, res: any) {
  ...
  async v1_payment(req: any, res: any) {
  const {
    userId,
    iid,
    invoiceNo,
  ...
  fetchFeeTypes(req: any, res: any) {
  db.query("SELECT *FROM feesType", (err, result) => {
    res.json({ message: result });
  });
}

  fetchFeeTypesforApprovel(req: any, res: any) {
  db.query("SELECT *FROM feesType WHERE pstatus=''", (err, result) => {
    res.json({ message: result });
  });
}

  fetchFeeTypesById(req: any, res: any) {
  const { id } = req.body;
  ...
  deleteFeeTypes(req: any, res: any) {
  const { id } = req.body;
  ...
  deleteExtraFeeInfo(req: any, res: any) {
  const { id } = req.body;
  ...
  deleteExtraFeeInfoList(req: any, res: any) {
  const { id } = req.body;
  ...
  deleteDiscountType(req: any, res: any) {
  const { id } = req.body;
  ...
  fetchExtraFeeInfo(req: any, res: any) {
    const { campus } = req.body;
  ...
  UpdateExtraFeeInfo(req: any, res: any) {
  ...
  fetchFeeInfoApprovel(req: any, res: any) {
  db.query("SELECT *FROM feeInfo WHERE pstatus=''", (err, result) => {
    res.json({ message: result });
  });
}

  UpdateFeeInfoApprovel(req: any, res: any) {
  ...
  fetchFeeInfoById(req: any, res: any) {
  const { id } = req.body;
  ...
  addExtraFeeInfo(req: any, res: any) {
  const {
    facility_name,
    facility_fee,
    recurring,
  ...
  fetchFeeInfoByName(req: any, res: any) {
  const { feeType } = req.body;
  ...
  addDiscountType(req: any, res: any) {
  ...
  UpdateDiscountType(req: any, res: any) {
  ...
  getDiscountType(req: any, res: any) {
  db.query("SELECT *FROM discount_type ", (err, result) => {
    res.json({ message: result });
  });
}

  getDiscountTypeById(req: any, res: any) {
  const { id } = req.body;
  ...
  addDiscountStudent(req: any, res: any) {
  const {
    student_id,
    discountType,
    discount,
  ...
  getDiscountDataByStudentId(req: any, res: any) {
  const { student_id } = req.body;
  db.query(
  ...
  assignDiscount(req: any, res: any) {
  const {
    student_id,
    Class,
    section,
  ...
  getassignDiscount(req: any, res: any) {
  db.query("SELECT *FROM assign_discount", (err, result) => {
    res.json({ message: result });
  });
}

  getassignDiscountApprove(req: any, res: any) {
  db.query("SELECT *FROM assign_discount WHERE status=''", (err, result) => {
    res.json({ message: result });
  });
}

  UpdateAssignDiscountApprove(req: any, res: any) {
  const { id, status, note } = req.body;
  db.query(
  ...
  getassignDiscountforUpdate(req: any, res: any) {
  ...
  getassignDiscounttById(req: any, res: any) {
  const { id } = req.body;
  ...
  getassignDiscounttByStudentId(req: any, res: any) {
  const { student_id } = req.body;
  db.query(
  ...
  getAllStudentDiscount(req: any, res: any) {
  ...
  deleteAssignDiscount(req: any, res: any) {
   const { id } = req.body;
  ...
  UpdateAssignDiscount(req: any, res: any) {
  const {
    id,
    student_id,
    discount_type,
  ...
  student_fees_due_report(req: any, res: any) {
  ...
  getStudentDueBalance(req: any, res: any) {
  const { student_id } = req.body;
  ...
  async manualClassFeesForward(req: any, res: any) {
  if (isClassFeeForwardRunning) {
    return res.json({
      success: false,
