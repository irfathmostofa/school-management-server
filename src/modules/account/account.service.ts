...
GROUP BY ih.id, ih.income_head ORDER BY head`;
  ...
  accountSummary(req: any, res: any) {
...
`;
  ...
  accountSummaryForDaily(req: any, res: any) {
  ...
  updateAmountTransfer(req: any, res: any) {
  const {
    transfer_id,
    transfer_date,
    amount,
  ...
  deleteStudentIncome(req: any, res: any) {
  const { id } = req.body;
  ...
  deleteAmountTransfer(req: any, res: any) {
  const { id } = req.body;
  ...
  addStudentIncome(req: any, res: any) {
  const {
    student_id,
    session,
    type,
  ...
  UpdateStudentIncome(req: any, res: any) {
  ...
  approveExpenseData(req: any, res: any) {
  const { id } = req.body;
  ...
  approveIncomeData(req: any, res: any) {
  const { id } = req.body;
  ...
  addGenaralIncome(req: any, res: any) {
  ...
  getStudentIncome(req: any, res: any) {
  ...
  getStudentIncomeById(req: any, res: any) {
  ...
  UpdateLibrarySell(req: any, res: any) {
  const { id } = req.body;
  db.query(
  ...
  Updateprincipaleligible(req: any, res: any) {
  const { id } = req.body;
  db.query(
  ...
  getExpensedataWithEmployeeInfo(req: any, res: any) {
  const query = `
  SELECT 
      payment.*,
      bank.bank_name,
  ...
  getAccountTransactionsbyId(req: any, res: any) {
  const { id } = req.body;
  ...
  getExpensedata(req: any, res: any) {
  db.query(
  ...
  getPattyCashFromPayment(req: any, res: any) {
  db.query(
  ...
  addPattyCashItem(req: any, res: any) {
  ...
  getPattyCashItem(req: any, res: any) {
  ...
  getExpensedataById(req: any, res: any) {
  const { id } = req.body;
  ...
  getstudentIncomeaById(req: any, res: any) {
  const { payment_id } = req.body;
  db.query(
  ...
  UpdateExpensedata(req: any, res: any) {
  ...
  getAmountTransferDataForReport(req: any, res: any) {
  ...
  getExpensedataForReport(req: any, res: any) {
  ...
  getAllCollectedfeesReport(req: any, res: any) {
  const { startDate, endDate, type } = req.body;
  ...
  getIncomeDataForReport(req: any, res: any) {
  const { startDate, endDate, type } = req.body;
  ...
  getAllIncomedata(req: any, res: any) {
  const { type } = req.body;
  ...
  getGeneralIncomedata(req: any, res: any) {
  db.query(
  ...
  addExpense_head(req: any, res: any) {
  ...
  updateExpense_head(req: any, res: any) {
  ...
  approveExpenseHead(req: any, res: any) {
  ...
  getExpense_head(req: any, res: any) {
  db.query("SELECT *FROM expense_head", (err, result) => {
    res.json({ message: result });
  });
}

  deleteExpense_head(req: any, res: any) {
  const { id } = req.body;
  ...
  deleteIncomeHead(req: any, res: any) {
  const { id } = req.body;
  ...
  addincome_head(req: any, res: any) {
  ...
  Updateincome_head(req: any, res: any) {
  ...
  approveIncomeHead(req: any, res: any) {
  const { id,status,note } = req.body;
  db.query(
    "UPDATE income_head SET ? WHERE id = ?",
    [{ status,note }, id],
  ...
  getincome_head(req: any, res: any) {
  db.query("SELECT *FROM income_head", (err, result) => {
    res.json({ message: result });
  });
}

  getincomeheadById(req: any, res: any) {
  const { id } = req.body;
  ...
  getincomeHeadStudent(req: any, res: any) {
  db.query(
  ...
  getincomeHeadGeneral(req: any, res: any) {
  db.query(
  ...
  addSupplyPayment(req: any, res: any) {
  ...
  getSupplyPayment(req: any, res: any) {
  db.query("SELECT *FROM supply_payment", (err, result) => {
    res.json({ message: result });
  });
}

  getSupplyPaymentById(req: any, res: any) {
  const { id } = req.body;
  ...
  getSupplyPaymentCountFR(req: any, res: any) {
  ...
  getSupplyPaymentCountSP(req: any, res: any) {
  db.query("SELECT *FROM supply_payment", (err, result) => {
    var elist = [];
    result.map((item, index) => {
      var id = item.sp_id;
  ...
  getbudgetitemById(req: any, res: any) {
  const { id } = req.body;
  ...
  updatebudgetitemById(req: any, res: any) {
  ...
  updatebudgetDoneById(req: any, res: any) {
  const { bid } = req.body;
  db.query(
  ...
  budgetitemdelete(req: any, res: any) {
  const { id } = req.body;
  ...
  updatebudgetinfoById(req: any, res: any) {
  ...
  getbudgetFullinfo(req: any, res: any) {
  const { bid } = req.body;
  ...
  getbudgetAllinfo(req: any, res: any) {
  db.query("SELECT *FROM budget", (err, result) => {
    res.json({ message: result });
  });
}

  addKarzRequest(req: any, res: any) {
  const {
    name,
    emp_id,
    designation,
  ...
  getKarzRequest(req: any, res: any) {
  db.query("SELECT *FROM karz_request", (err, result) => {
    res.json({ message: result });
  });
}

  getKarzRequestByUser(req: any, res: any) {
  ...
  getKarzRequestById(req: any, res: any) {
  const { id } = req.body;
  ...
  ApprovelkarzById(req: any, res: any) {
  const { id, user, approvel } = req.body;
  if (user == "Super Admin") {
    db.query(
      "UPDATE karz_request SET ? WHERE id = ?",
  ...
  addBankAccount(req: any, res: any) {
  ...
  addBulkBankInfo(req: any, res: any) {
  ...
  getBankAccount(req: any, res: any) {
  ...
  getFinalSalarySheetForPay(req: any, res: any) {
...
WHERE 
  ...
  getFinalSalarySheetByMonth(req: any, res: any) {
  ...
  getFinalSalarySheetByID(req: any, res: any) {
  ...
  getOverTimeReportByID(req: any, res: any) {
  const { emp_id, session } = req.body;
