...
export class StudentService {
  ...
  getstudentParenttoken(req: any, res: any) {
  ...
  studentParentLogin(req: any, res: any) {
  ...
  getParentsChild(req: any, res: any) {
  ...
  getStudentDashboardbyID(req: any, res: any) {
  ...
  getStudentPreviousSession(req: any, res: any) {
  const { student_id} = req.body;
  db.query(
  ...
  async getHomeWorkList(req: any, res: any) {
  ...
  async getClassWorkList(req: any, res: any) {
  const { className, section, session, student_id, termName, subject, date } =
    req.body;
  const pageSize = parseInt(req.query.pageSize) || 20;
  const page = parseInt(req.query.page) || 1;
  ...
  async getClassTestList(req: any, res: any) {
  ...
  getStudentAttendanceByID(req: any, res: any) {
  ...
  getSubjectList(req: any, res: any) {
  ...
  getStudentClasssRoutine(req: any, res: any) {
  ...
  getStudentDiary(req: any, res: any) {
  ...
  getStudentExtraClass(req: any, res: any) {
  const { student_id, className, section, session, month } = req.body;
  const startOfMonth = `${month}-01`;
  const endOfMonth = `${month}-31`;
  db.query(
  ...
  getStudentLibraryItem(req: any, res: any) {
  ...
  getStudentEventNews(req: any, res: any) {
  ...
  getStudentAcademicCalendarNew(req: any, res: any) {
  ...
  getStudentAcademicCalendar(req: any, res: any) {
  ...
  updateDeviceToken(req: any, res: any) {
  ...
  getStudentAttendanceDevice(req: any, res: any) {
