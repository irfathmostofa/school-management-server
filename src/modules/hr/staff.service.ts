...
export class StaffService {
  ...
  updateHRISLetter(req: any, res: any) {
  ...
  deleteHRISLetter(req: any, res: any) {
  const { id } = req.body;
  ...
  addAppointmentletter(req: any, res: any) {
  ...
  addExperienceCertificate(req: any, res: any) {
  ...
  UpdateAppointmentletter(req: any, res: any) {
  const { id, cdate, des } = req.body;
  db.query(
  ...
  UpdateExperienceCertificate(req: any, res: any) {
  const { id, cdate, des } = req.body;
  db.query(
  ...
  UpdateNOCletter(req: any, res: any) {
  ...
  UpdateConfirmationletter(req: any, res: any) {
  const { id, cdate, des } = req.body;
  db.query(
  ...
  DeleteAppointmentletter(req: any, res: any) {
  const { id } = req.body;
  ...
  DeleteConfirmationletter(req: any, res: any) {
  const { id } = req.body;
  db.query(
  ...
  DeleteNOCletter(req: any, res: any) {
  const { id } = req.body;
  ...
  addConfirmationletter(req: any, res: any) {
  const {
    emp_id,
    fileno,
    name,
  ...
  getappointmentLetterById(req: any, res: any) {
  const { id } = req.body;
  ...
  getConfirmationLetterById(req: any, res: any) {
  const { id } = req.body;
  ...
  addDesignation(req: any, res: any) {
  ...
  getAllDesignation(req: any, res: any) {
  db.query("SELECT *FROM designation", (err, result) => {
    res.json({ message: result });
  });
}

  getAllTitle(req: any, res: any) {
  ...
  getdesignationByID(req: any, res: any) {
  const { id } = req.body;
  ...
  addEmployeeAttendancePeriod(req: any, res: any) {
  const {
    emp_id,
    attendance_inTime,
    attendance_outTime,
  ...
  async addBulkEmployee(req: any, res: any) {
  const { selectedCSVData, session } = req.body;
  ...
  addBulkAttendance(req: any, res: any) {
  ...
  getAttendanceForEmployee(req: any, res: any) {
  ...
  getAttendanceSummaryForAllEmployee(req: any, res: any) {
  const { empID, startDate, endDate } = req.body;
...
WHERE attendance_device.date BETWEEN ? AND ?`;
  ...
  getlateEmployeeList(req: any, res: any) {
  ...
  updateovertimeeligibility(req: any, res: any) {
  ...
  updateEmployeeStatus(req: any, res: any) {
  ...
  getAllAttendanceInOutTimeWithSalary(req: any, res: any) {
  db.query(
  ...
  getAllAttendance(req: any, res: any) {
  ...
  getDailyAttendance(req: any, res: any) {
  ...
  getAllAttendanceByID(req: any, res: any) {
  const page = parseInt(req.query.page) || 1;
  const pageSize = parseInt(req.query.pageSize) || 20;
  const offset = (page - 1) * pageSize;
  ...
  getAllAttendanceDeviceByID(req: any, res: any) {
  const page = parseInt(req.query.page) || 1;
  const pageSize = parseInt(req.query.pageSize) || 20;
  const offset = (page - 1) * pageSize;
  const { empID, month } = req.body;
  ...
  getPrincipleData(req: any, res: any) {
  db.query(
  ...
  getTeacherAllData(req: any, res: any) {
...
let query2 = "SELECT * FROM employee WHERE emp_type = 'Academic' AND campus = 'Boys & Girls Campus'";
  ...
  getTeacherAllDataByDepartment(req: any, res: any) {
  ...
  getAHODAllDataByDepartment(req: any, res: any) {
  const { department } = req.body;
  ...
  getACCODAllDataBySchool(req: any, res: any) {
  ...
  getTeacherAllDataBySchool(req: any, res: any) {
  const { school } = req.body;
  ...
  getAdminAllData(req: any, res: any) {
  db.query(
  ...
  getEmployeeCount(req: any, res: any) {
  db.query(
  ...
  getEmployeeByidd(req: any, res: any) {
  const { id } = req.body;
  ...
  EmployeeAttendancePeriod(req: any, res: any) {
  ...
  getEmployeeAttendancePeriod(req: any, res: any) {
  db.query("SELECT *FROM employee_attendance_period", (err, result) => {
    res.json({ message: result });
  });
}

  getEmployeeAttendanceDevice(req: any, res: any) {
  ...
  DeleteEmployeeAttendancePeriod(req: any, res: any) {
  const { id } = req.body;
  db.query(
  ...
  addTeacherEvaluation(req: any, res: any) {
  const {
    termName,
    department,
    teacherID,
  ...
  getTeacherEvaluation(req: any, res: any) {
  ...
  getAdminEvaluationFormList(req: any, res: any) {
  const { designation } = req.body;
  ...
  getCompletedEvolutionFor(req: any, res: any) {
  ...
  evaluationQuestionsForm(req: any, res: any) {
  const {
    ev_ID,
    evaluator,
    department,
  ...
  updateEvaluationQuestionsForm(req: any, res: any) {
  const {
    ev_ID,
    evaluator,
    department,
  ...
  evaluationFormStatus(req: any, res: any) {
  ...
  getEvaluationAnswerListByID(req: any, res: any) {
  ...
  evaluationAnsweForm(req: any, res: any) {
  const {
    ev_ID,
    evaluated_by_ID,
    evaluated_by_Name,
  ...
  addadminevaluationForm(req: any, res: any) {
  const {
    Form_ID,
    Employee_Name,
    Employee_ID,
  ...
  updateadminevaluationForm(req: any, res: any) {
  ...
  updatePrincipalApproval(req: any, res: any) {
  ...
  getEvaluationFormList(req: any, res: any) {
  const { type } = req.body;
  db.query(
    `SELECT
    EQ.*,
...
`,
  ...
  async getSalaryByAccount(req: any, res: any) {
...
GROUP BY salary_report_by_HR.emp_id;
  ...
  async getSalaryReportByHR(req: any, res: any) {
  const { selectedMonth } = req.body;
...
IFNULL(a.lateCount, 0) AS lateCount,
  ...
  async getOverTimeReportByHR(req: any, res: any) {
  const { selectedMonth } = req.body;
  ...
  async fetchPreviousSalaryReportByHR(req: any, res: any) {
  const { selectedMonth } = req.body;
  ...
  addFinalSalarySheet(req: any, res: any) {
  const {
    employeeDataList,
    creator_ID,
    creator_Name,
...
`;
  ...
  addSalaryReportByHR(req: any, res: any) {
  const {
    employeeDataList,
    creator_ID,
    creator_Name,
...
`;
  ...
  addOverTimeReportByHR(req: any, res: any) {
  const {
    employeeDataList,
    creator_ID,
    creator_Name,
...
`;
  ...
  fetchPreviousOverTimeReportByHR(req: any, res: any) {
  const { selectedMonth } = req.body;
  ...
  addSalaryIncreament(req: any, res: any) {
  const {
    emp_id,
    emp_name,
    emp_department,
  ...
  getAllSalaryHistory(req: any, res: any) {
  const page = parseInt(req.query.page) || 1;
  const pageSize = parseInt(req.query.pageSize) || 20;
  const offset = (page - 1) * pageSize;
  ...
  updateSalaryIncreament(req: any, res: any) {
  ...
  addaitparameter(req: any, res: any) {
  ...
  getaitparameter(req: any, res: any) {
  ...
  deleteallowance(req: any, res: any) {
  const { emp_id } = req.body;
  ...
  addUserIdPrefix(req: any, res: any) {
  const {
    id_prefix,
    type,
    session,
  ...
  getallprefix(req: any, res: any) {
  db.query("SELECT *FROM user_id_prefix", (err, result) => {
    res.json({ message: result });
  });
}

  generateStudentId(req: any, res: any) {
  ...
  deleteUserIdPrefix(req: any, res: any) {
  const { id } = req.body;
