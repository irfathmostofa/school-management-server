...
export class StadService {
  ...
  postHifzDailyProgress(req: any, res: any) {
  const {
    student_id,
    campus,
    session,
  ...
  updateHifzDailyProgress(req: any, res: any) {
  const {
    student_id,
    campus,
    session,
  ...
  getHifzDailyProgressByStudentId(req: any, res: any) {
  ...
  getHifzDailyProgressByStudentIdMonth(req: any, res: any) {
  ...
  getHifzDailyProgress(req: any, res: any) {
  ...
  getHifzDailyProgressInDate(req: any, res: any) {
  ...
  deleteHifzDailyProgress(req: any, res: any) {
  const { id } = req.body;
  db.query(
  ...
  postHifzTermTargetSetup(req: any, res: any) {
  ...
  updateHifzTermTargetSetup(req: any, res: any) {
  const { student_id, campus, session, halakah, term, type, month, lesson } =
    req.body;
  ...
  getHifzTermTargetSetup(req: any, res: any) {
  ...
  getHifzTermTargetSetupMonth(req: any, res: any) {
  ...
  getHifzSprhalaka(req: any, res: any) {
  ...
  deleteHifzTermTargetSetup(req: any, res: any) {
  const { id } = req.body;
  db.query(
  ...
  getHifzSprTargetByStudentId(req: any, res: any) {
  ...
  async postIncidentReport(req: any, res: any) {
  const {
    student_id,
    submitDate,
    dateOfOccurrence,
  ...
  async updateIncidentReport(req: any, res: any) {
  ...
  getIncidentReport(req: any, res: any) {
  ...
  deleteIncidentReport(req: any, res: any) {
  const { id } = req.body;
  ...
  getHifzSprHalakahStudents(req: any, res: any) {
...
`;
  ...
  getSoldFormForDashboard(req: any, res: any) {
  ...
  getAdmissionForDashboard(req: any, res: any) {
  ...
  deleteSoldForm(req: any, res: any) {
  ...
  getadmissioninfo(req: any, res: any) {
  db.query("SELECT *FROM online_admission", (err, result) => {
    res.json({ message: result });
  });
}

  getAllSiblingData(req: any, res: any) {
  db.query(
  ...
  getSiblingData(req: any, res: any) {
  ...
  fetchApplicants(req: any, res: any) {
  ...
  fetchApplicantsAlldata(req: any, res: any) {
  ...
  fetchApplicantsAdmissionTest(req: any, res: any) {
  db.query("SELECT *FROM admission WHERE eligible_status=''", (err, result) => {
    res.json({ message: result });
  });
}

  fetchApplicantsAdmitCard(req: any, res: any) {
  ...
  generateAdmissionAdmitCard(req: any, res: any) {
  const { form_number } = req.body;
  ...
  fetchApplicantsbyID(req: any, res: any) {
  const { id } = req.body;
  db.query(
  ...
  deleteApplicantById(req: any, res: any) {
  const { id } = req.body;
  ...
  fetchApplicantsbyFormNo(req: any, res: any) {
  const { form_number } = req.body;
  db.query(
  ...
  fetchAllAdmittedStudents(req: any, res: any) {
  db.query(
  ...
  fetchAdmittedStudentsForFeesForward(req: any, res: any) {
  ...
  fetchAdmittedStudents(req: any, res: any) {
  const {
    Class,
    section,
    session,
  ...
  fetchNotEnrolledStudents(req: any, res: any) {
  const {
    Class,
    section,
    session,
  ...
  fetchEligibleStudents(req: any, res: any) {
  ...
  getAdmittedlaststudent(req: any, res: any) {
  db.query(
  ...
  post_getSiblingData(req: any, res: any) {
  const { student_id, session } = req.body;
  db.query(
    "SELECT *FROM student WHERE student_id = ? AND session = ?",
    [student_id, session],
  ...
  async addBulkStudent(req: any, res: any) {
  const { selectedCSVData } = req.body;
  ...
  UpdateStudentAid(req: any, res: any) {
  const {
    id,
    admission_discount,
    admission_amount,
  ...
  async admissionformsubmit(req: any, res: any) {
  const {
    session,
    form_number,
    campus,
  ...
  admissionformUpdate(req: any, res: any) {
  ...
  updateAdmissionPrincipalApprove(req: any, res: any) {
  ...
  updateadmissionform(req: any, res: any) {
  const {
    id,
    form_number,
    submission_date,
  ...
  admissiontestresult(req: any, res: any) {
  const {
    session,
    test_date,
    form_number,
  ...
  getAdmissionTestResult(req: any, res: any) {
  db.query(`
    SELECT 
      at.*,
      a.gender,
  ...
  getAdmissionTestResultEligible(req: any, res: any) {
  db.query("SELECT *FROM admission_test WHERE status1=1", (err, result) => {
    res.json({ message: result });
  });
}

  getAdmissionTestResultByid(req: any, res: any) {
  const { id } = req.body;
  ...
  deleteAdmissionTestResultByid(req: any, res: any) {
  const { id } = req.body;
  ...
  getApplientViewByid(req: any, res: any) {
  const { id } = req.body;
  ...
  UpdateHouseById(req: any, res: any) {
  ...
  approveHouseById(req: any, res: any) {
  ...
  getCategoryforprincipal(req: any, res: any) {
  db.query("SELECT *FROM student_category WHERE pstatus=''", (err, result) => {
    res.json({ message: result });
  });
}

  getCategoryById(req: any, res: any) {
  const { id } = req.body;
  ...
  UpdateCategoryById(req: any, res: any) {
  ...
  CategoryApprove(req: any, res: any) {
  const { id, status } = req.body;
  db.query(
    "UPDATE student_category SET ? WHERE id = ?",
    [{ pstatus: status }, id],
  ...
  getEligiblestudent(req: any, res: any) {
...
db.query(
  ...
  HifzSprApprove(req: any, res: any) {
  ...
  addHifzSprStudent(req: any, res: any) {
  const {
    halaqaNumber,
    student_name,
    student_id,
  ...
  transferHalakahStudents(req: any, res: any) {
  ...
  getHifzSPRStudent(req: any, res: any) {
  const { session, campus } = req.body;
  db.query(
  ...
  HifzSprStudentApprove(req: any, res: any) {
  const { id, status, note } = req.body;
  db.query(
  ...
  HifzSprStudentStatus(req: any, res: any) {
  const { id, status} = req.body;
  db.query(
  ...
  addHifzStudent(req: any, res: any) {
  ...
  deleteStudentClub(req: any, res: any) {
  const { id } = req.body;
  db.query(
  ...
  getStudentHifz(req: any, res: any) {
  db.query("SELECT *FROM hifz_student", (err, result) => {
    res.json({ message: result });
  });
}

  deleteHifzStudent(req: any, res: any) {
  const { id } = req.body;
  db.query(
  ...
  getStudentHifzApprovel(req: any, res: any) {
  db.query("SELECT *FROM hifz_student WHERE pstatus=''", (err, result) => {
    res.json({ message: result });
  });
}

  StudentHifzApprove(req: any, res: any) {
  const { id, status, note } = req.body;
  db.query(
  ...
  getStudentViewByid(req: any, res: any) {
  ...
  getStudentViewByidAdmincard(req: any, res: any) {
  const { id } = req.body;
  ...
  getStudentForPrincipalAprrovel(req: any, res: any) {
  db.query(
  ...
  ApprovePrincipalApproveStudent(req: any, res: any) {
  ...
  getStudentIDCardViewByid(req: any, res: any) {
  ...
  getEligibleStudentIDCardViewByid(req: any, res: any) {
  const { student_id } = req.body;
  ...
  getEligibleStudentViewByid(req: any, res: any) {
  const { id } = req.body;
  db.query(
  ...
  getAllEligibleStudent(req: any, res: any) {
  db.query(
    "SELECT *FROM student WHERE id = ? AND eligible=1",
    id,
    (err, result) => {
  ...
  getClub(req: any, res: any) {
  db.query("SELECT *FROM club", (err, result) => {
    res.json({ message: result });
  });
}

  getClubApprovel(req: any, res: any) {
  db.query("SELECT *FROM club WHERE status=''", (err, result) => {
    res.json({ message: result });
  });
}

  approveClubById(req: any, res: any) {
  const { id, status } = req.body;
  db.query(
  ...
  addStudentClub(req: any, res: any) {
  ...
  getStudentClub(req: any, res: any) {
  const query = `
    SELECT 
      h.*, 
      sa.*
  ...
  fetchStudentByid(req: any, res: any) {
  const { id } = req.body;
  ...
  fetchStudentBySTid(req: any, res: any) {
  const { student_id } = req.body;
  db.query(
    "SELECT *FROM student WHERE student_id = ?",
    student_id,
  ...
  deleteAdmitCard(req: any, res: any) {
     const { student_id } = req.body;
  ...
  addEligibleStudentForExam(req: any, res: any) {
  ...
  gettmpPassdata(req: any, res: any) {
  db.query("SELECT *FROM temporary_pass", (err, result) => {
    res.json({ message: result });
  });
}

  gettmpPassdataforApprovel(req: any, res: any) {
  db.query("SELECT *FROM temporary_pass WHERE status=''", (err, result) => {
    res.json({ message: result });
  });
}

  UpdatetmpPassdataApprovel(req: any, res: any) {
  const { id, status, note } = req.body;
  db.query(
  ...
  gettmpPassByID(req: any, res: any) {
  const { student_id } = req.body;
  db.query(
  ...
  getTC(req: any, res: any) {
  db.query("SELECT *FROM TCapplication", (err, result) => {
    res.json({ message: result });
  });
}

  getTCById(req: any, res: any) {
  const { id } = req.body;
  ...
  TCprincipalApprove(req: any, res: any) {
  const { id } = req.body;
  ...
  TCreturnStudent(req: any, res: any) {
  const { id } = req.body;
