...
export class AdminService {
  ...
  deleteAcadEvent_event_ID(req: any, res: any) {
  ...
  getAcademicEvent(req: any, res: any) {
...
//   }
  ...
  async edittasks_task_ID(req: any, res: any) {
  ...
  tasks_taskID_username(req: any, res: any) {
  ...
  comments_taskID_isComment(req: any, res: any) {
  ...
  editnote_stickyID_(req: any, res: any) {
  ...
  taskstatus_taskID_userName(req: any, res: any) {
  const { taskID, userName } = req.params;
  ...
  users_userName(req: any, res: any) {
  ...
  tasks_userName(req: any, res: any) {
  const { userName } = req.params;
  ...
  stickynotes_userName(req: any, res: any) {
  const { userName } = req.params;
...
GROUP BY
 ...
 ORDER BY noteDate DESC`;
  ...
  singletask_taskID_userName(req: any, res: any) {
  const { taskID, userName } = req.params;
  ...
  guests_task_ID(req: any, res: any) {
  const { task_ID } = req.params;
  ...
  comments_taskID(req: any, res: any) {
  ...
  getEventsInfoById(req: any, res: any) {
  ...
  getEventsTaskById(req: any, res: any) {
  const { id } = req.body;
  ...
  UpdateEventsTask(req: any, res: any) {
  ...
  getDailyTaskUser(req: any, res: any) {
  ...
  getDailyTaskAllUser(req: any, res: any) {
  ...
  getDailyTaskByDate(req: any, res: any) {
  const { date } = req.body;
  db.query(
  ...
  UpdateDailyTaskStatus(req: any, res: any) {
  ...
  DeleteRouteById(req: any, res: any) {
  const { id } = req.body;
  ...
  AssignRouteEmployee(req: any, res: any) {
  ...
  geAssignRouteEmployee(req: any, res: any) {
  db.query(
  ...
  getApproveCount(req: any, res: any) {
  db.query(
    `
