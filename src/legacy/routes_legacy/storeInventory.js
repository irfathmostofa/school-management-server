...
router.post("/getProductType", (req, res) => {
  db.query("SELECT *FROM product_category ", (err, result) => {
    res.json({ message: result });
  });
});
router.post("/getProductTypeinduById", (req, res) => {
  const { id } = req.body;
...
router.post("/getProductTypeById", (req, res) => {
...
router.post("/UpdateProductType", (req, res) => {
...
router.post("/getProductLastID", (req, res) => {
  const { cat } = req.body;
  db.query(
...
router.post("/getStudentProducts", (req, res) => {
...
router.post("/addTransferProduct", (req, res) => {
  const {
    product_id,
    product_name,
    transferCampus,
...
router.post("/updateTransferProduct", (req, res) => {
...
router.post("/updateTransferHistory", (req, res) => {
...
router.post("/getLibraryItems", (req, res) => {
  //   const {session} = req.body;
...
router.post("/getLibraryItemByID", (req, res) => {
...
router.post("/getLibraryIssuedItems", (req, res) => {
...
router.post("/addLibraryIssueItems", async (req, res) => {
  const {
    receiver_id,
    receiver_name,
    receiver_type,
...
router.post("/getIssueInfo", (req, res) => {
...
router.post("/getLibraryReturnItems", (req, res) => {
...
router.post("/addLibraryReturnItems", async (req, res) => {
  const {
    giver_id,
    giver_name,
    giver_type,
...
// GRN
router.post("/addGRNinfo", (req, res) => {
...
router.post("/getGRNinfo", (req, res) => {
  db.query("SELECT *FROM grn ORDER BY id DESC", (err, result) => {
    res.json({ message: result });
  });
});

router.post("/getAllinfoByGRN", (req, res) => {
...
router.post("/updateGRNBillstatus", (req, res) => {
...
router.post("/updateGRNstatus", (req, res) => {
  const { grn_id } = req.body;
  db.query(
    "UPDATE grn SET ? WHERE grn_id=?",
...
router.post("/addGRNitem", (req, res) => {
...
//mdr
router.post("/addMDRinfo", (req, res) => {
...
router.post("/getMDRinfo", (req, res) => {
    const { user } = req.body;
...
router.post("/updateMDRstatus", (req, res) => {
...
router.post("/getAllMDRinfoByID", (req, res) => {
...
router.post("/addMDRitem", (req, res) => {
...
router.post("/getCustomerByID", (req, res) => {
  const { id } = req.body;
...
router.post("/getAllSearchCustomer", (req, res) => {
...
router.post("/getAllCustomer", (req, res) => {
  db.query(
...
router.post("/getLastQuotationId", (req, res) => {
  db.query(
...
router.post("/getquotationItemById", (req, res) => {
...
router.post("/getallinvoice", (req, res) => {
...
router.post("/getvendorID", (req, res) => {
  const { id } = req.body;
...
router.post("/getLastPurchaseId", (req, res) => {
  db.query(
...
router.post("/addStoreProduct", (req, res) => {
  const {
    session,
    customer_name,
    total,
...
router.post("/getLastStoreProductId", (req, res) => {
  db.query(
    "SELECT product_id FROM store_product ORDER BY id DESC LIMIT 1",
    (err, result) => {
      if (err) {
...
router.post("/getallStoreProductItemlist", (req, res) => {
...
router.post("/getStoreProductItemById", (req, res) => {
...
router.post("/getallbillinfo", (req, res) => {
