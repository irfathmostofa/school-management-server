...
router.post("/getDashboardMonthlyFeesData", (req, res) => {
...
router.post("/getDashboardLeaveRequest", (req, res) => {
...
router.post("/getDashboardExpenseData", (req, res) => {
  const { type } = req.body;
...
router.post("/getDashboardUnPaidFeesData", (req, res) => {
...
router.post("/dashboardStat", async (req, res) => {
...
router.post("/dashboardStatForEmployee", async (req, res) => {
  const { campus } = req.body; 
...
router.post("/sidebarBadgeCount", async (req, res) => {
...
router.post("/DailyAttendanceInfo", (req, res) => {
  const { campus } = req.body;
...
router.post("/DailyAttendanceForClassSection", (req, res) => {
  const { campus } = req.body;
...
router.post("/DailyLessonPlanForClassSection", (req, res) => {
...
router.post("/DailyClassTestForClassSection", (req, res) => {
...
router.post("/DailyHomeworkForClassSection", (req, res) => {
    const {session } = req.body;
