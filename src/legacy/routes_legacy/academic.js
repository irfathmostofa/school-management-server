...
router.post("/deleteExamSchedule", (req, res) => {
  const { id } = req.body;
...
router.post("/getPeriodsList", (req, res) => {
...
router.post("/getPeriods", (req, res) => {
  const { class_name, campus, session } = req.body;
...
router.post("/updatePeriods", (req, res) => {
...
router.post("/deletePeriods", (req, res) => {
  const { id } = req.body;
...
router.post("/bulkUpsertRoutine", async (req, res) => {
...
router.post('/getRoutinesForTeacher', async (req, res) => {
...
router.post('/getRoutinesForView', (req, res) => {
...
router.post('/getRoutines', (req, res) => {
    const { class_name, section_name, campus, session } = req.body;
    const query = `
        SELECT 
            day, 
...
router.post("/getgroupByClassSection", (req, res) => {
    const{campus,session,class_name,section}=req.body;
...
router.post("/addGroupAssignStudents", (req, res) => {
...
router.post("/getGroupAssignStudents", (req, res) => {
...
router.post("/updateGroupAssignStudents", (req, res) => {
...
router.post("/deleteGroupAssignStudents", (req, res) => {
  const { id } = req.body;
...
router.post("/addGroupComments", (req, res) => {
...
router.post("/getGroupComments", (req, res) => {
  const { group_id } = req.body;
...
router.post("/deleteSubstituteTeacher", (req, res) => {
  const { id } = req.body;
...
router.post("/UpdateStatusSubstituteTeacher", (req, res) => {
...
router.post("/addSubstituteTeacher", (req, res) => {
...
router.post("/getSubstituteTeacherData", (req, res) => {
...
router.post("/getSectionApprovel", (req, res) => {
  db.query("SELECT *FROM section WHERE pstatus=''", (err, result) => {
    res.json({ message: result });
  });
});
router.post("/getSubjectApprovel", (req, res) => {
  db.query("SELECT *FROM subject_list WHERE pstatus=''", (err, result) => {
    res.json({ message: result });
  });
});

router.post("/UpdateSectionApprovel", (req, res) => {
  const { id, status } = req.body;
  db.query(
    "UPDATE section SET ? WHERE id = ?",
    [{ pstatus: status }, id],
...
router.post("/UpdateSubjectApprovel", (req, res) => {
  const { id, status } = req.body;
  db.query(
    "UPDATE subject_list SET ? WHERE id = ?",
    [{ pstatus: status }, id],
...
router.post("/getStudentByClassSectionWithCampus", (req, res) => {
...
router.post("/getStudentByClassSection", (req, res) => {
...
router.post("/getClassApprovel", (req, res) => {
  db.query("SELECT *FROM class_name WHERE pstatus=''", (err, result) => {
    res.json({ message: result });
  });
});

router.post("/UpdateClassApprovel", (req, res) => {
  const { id, status } = req.body;
  db.query(
...
router.post("/getSessionActive", (req, res) => {
...
router.post("/getAttendanceForClass", (req, res) => {
...
router.post("/getTotalAttendanceForClassSection", (req, res) => {
...
router.post("/deleteStudentAttendence", (req, res) => {
...
router.post("/getTermReport", (req, res) => {
...
router.post("/addStudentClassPerformance", (req, res) => {
...
router.post("/getStudentClassPerformance", (req, res) => {
...
router.post("/deleteStudentAttendance", (req, res) => {
...
router.post("/addStudentAttendance", (req, res) => {
...
router.post("/addStudentHomeworkRecords", (req, res) => {
...
router.post("/addStudentClassworkRecords", (req, res) => {
...
router.post("/addStudentPerformance", (req, res) => {
...
router.post("/getStudentPerformance", (req, res) => {
...
router.post("/addStudentClassTestRecords", (req, res) => {
...
router.post("/getStudentClassTestRecords", (req, res) => {
...
router.post("/getStudentClassWorkRecords", (req, res) => {
...
router.post("/getStudentHomeWorkRecords", (req, res) => {
  const { selectedWorkID } = req.body;
...
router.post("/addTermReportParameter", (req, res) => {
...
router.post("/getTermReportParameterBySubject", (req, res) => {
...
router.post("/addStudentTermProjectRecords", (req, res) => {
...
router.post("/addStudentTermRecords", (req, res) => {
...
router.post("/getStudentTermReport", (req, res) => {
...
router.post("/addJrStudentTermRecords", (req, res) => {
...
router.post("/addStudentHomeWork", (req, res) => {
  const {
    school,
    className,
    termName,
...
router.post("/updateStudentWork", async (req, res) => {
...
router.post("/addStudentClassWork", async (req, res) => {
  const {
    school,
    className,
    termName,
...
router.post("/getStudentHomeWork", (req, res) => {
...
router.post("/getAllStudentTermProjectRecords", (req, res) => {
...
router.post("/getStudentClassWork", (req, res) => {
  const { className, section, session, subject, termName, date } = req.body;
  const dateObj = new Date(date);
  const formattedDate = dateObj.toISOString().split('T')[0];
...
router.post("/ClassTestPublish", (req, res) => {
  const { id, status } = req.body;
...
router.post("/getStudentClassTest", (req, res) => {
  const { className, termName, section, session, subject } = req.body;
...
router.post("/getStudentClassTestUpdate", (req, res) => {
...
router.post("/getSingleStudentMonthlyReport", (req, res) => {
...
router.post("/getSingleStudentJrMonthlyReport", (req, res) => {
...
router.post("/getSingleStudentTermReport", (req, res) => {
...
router.post("/getSingleJrStudentTermReport", (req, res) => {
  const { student_id, termName, session, className } = req.body;
...
router.post("/getStudentTermMarks", (req, res) => {
...
router.post("/getJrStudentTermMarks", (req, res) => {
...
router.post("/getAllClassTeacherAndCoOrdinator", (req, res) => {
  db.query(
    `
 SELECT
...
router.post("/getClassTeacherAndCoOrdinator", (req, res) => {
  const { class_name, section_name, session } = req.body;
...
router.post("/addClassTeacher", (req, res) => {
...
router.post("/addClassCoOrd", (req, res) => {
...
router.post("/getAllGradeMarks", (req, res) => {
  const { session } = req.body;
...
router.post("/addGradeMarks", (req, res) => {
...
router.post("/getGradeMarksByClass", (req, res) => {
  const { className, session } = req.body;
...
router.post("/DeleteGradeMarksById", (req, res) => {
    const { id } = req.body;
...
router.post("/getPreTermReportForm", (req, res) => {
...
router.post("/getSingleStudentPreTermReport", (req, res) => {
...
router.post("/addPreTermReportForm", (req, res) => {
  const {
    termName,
    className,
    resultQuestion,
...
router.post("/addPreTermReportResponse", (req, res) => {
  const {
    termName,
    className,
    student_id,
...
router.post("/addJrSegmentForm", (req, res) => {
...
router.post("/getJrSegmentForm", (req, res) => {
...
router.post("/addJrResultResponse", (req, res) => {
...
router.post("/getPreviousJrResultResponse", (req, res) => {
...
router.post("/addClasssRoutine", (req, res) => {
...
router.post("/getClassRoutineByClassNSection", (req, res) => {
...
router.post("/getClasssRoutineByID", (req, res) => {
...
router.post("/addLessionPlan", (req, res) => {
  const {
    termName,
    className,
    subjectName,
...
router.post("/updateLessonApproval", (req, res) => {
...
router.post("/getLessionPlan", (req, res) => {
  const { termName, className, subjectName, session } = req.body;
...
router.post("/deleteLessonPlanById", (req, res) => {
  const { id } = req.body;
...
router.post("/adddepartmentmeetingPlan", (req, res) => {
...
router.post("/getdepartmentmeetingPlan", (req, res) => {
...
router.post("/updatedepartmentmeetingPlan", (req, res) => {
...
router.post("/promoteStudents", (req, res) => {
  const {
...
router.post("/getPromotedStudents", (req, res) => {
...
router.post("/approveDiary", async (req, res) => {
  const { id } = req.body;
...
router.post("/DeleteDiaryById", (req, res) => {
  const { id } = req.body;
  if (!id) {
    return res.status(400).json({ message: "Diary ID is required" });
  }
...
router.post("/addExtraClass", (req, res) => {
  const {
    selectedStudents,
    selectedClass,
    selectedSection,
...
router.post("/getExtraClass", (req, res) => {
...
router.post('/postWeeklyDates', (req, res) => {
...
router.post('/getWeeklyDates', (req, res) => {
...
router.post('/deleteLessonPlansSubjectData', async (req, res) => {
    try {
...
router.post("/DeleteWeeklyDatesById", async (req, res) => {
  const { id } = req.body;
...
router.post("/updateLessonPlans", async (req, res) => {
  const {
    weekly_date_id,
    day_of_week,
    subject_id,
...
router.post('/getWeeklyScheduleDataForUpdateId', (req, res) => {
...
router.post('/getWeeklyLessonPlanForCurrentDate', (req, res) => {
...
router.post('/getWeeklyScheduleById', (req, res) => {
  const { id } = req.body;
  const sql = `
...
router.post('/getWeeklySchedule', (req, res) => {
  const { session, campus } = req.body;
  const sql = `
...
router.post('/resultPublish', (req, res) => {
...
router.post('/getResultPublishInfo', (req, res) => {
...
router.post("/UpdateResultPublish", async (req, res) => {
  const { id, status } = req.body;
...
router.post("/UpdateMonthlyReportPublish", async (req, res) => {
  const { id, status } = req.body;
...
router.post("/getDataForMonthlyDataSubmit", async (req, res) => {
...
router.post('/postMonthlyProgressReport', (req, res) => {
...
router.post('/getMonthlyProgressReport', (req, res) => {
...
router.post("/deleteMonthlyProgressReport", (req, res) => {
  const { id } = req.body;
...
router.get("/AcademicTest", (req, res) => {
  res.send("Academic");
});
