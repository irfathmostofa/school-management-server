...
router.post("/addHRISLetter", (req, res) => {
...
router.post("/getHRISLetter", (req, res) => {
    const {type} =req.body;
...
router.post("/updateHRISLetter", (req, res) => {
...
router.post("/deleteHRISLetter", (req, res) => {
  const { id } = req.body;
...
router.post("/addAppointmentletter", (req, res) => {
...
router.post("/addExperienceCertificate", (req, res) => {
...
router.post("/addNOCletter", (req, res) => {
  const {
    emp_id,
    name,
    designation,
...
router.post("/UpdateAppointmentletter", (req, res) => {
  const { id, cdate, des } = req.body;
  db.query(
...
router.post("/UpdateExperienceCertificate", (req, res) => {
  const { id, cdate, des } = req.body;
  db.query(
...
router.post("/UpdateNOCletter", (req, res) => {
...
router.post("/UpdateConfirmationletter", (req, res) => {
  const { id, cdate, des } = req.body;
  db.query(
...
router.post("/DeleteAppointmentletter", (req, res) => {
  const { id } = req.body;
...
router.post("/DeleteConfirmationletter", (req, res) => {
  const { id } = req.body;
  db.query(
...
router.post("/DeleteNOCletter", (req, res) => {
  const { id } = req.body;
...
router.post("/addConfirmationletter", (req, res) => {
  const {
    emp_id,
    fileno,
    name,
...
router.post("/getappointmentLetter", (req, res) => {
  db.query("SELECT *FROM appointment_letter", (err, result) => {
    res.json({ message: result });
  });
});
router.post("/getConfirmationLetter", (req, res) => {
  db.query("SELECT *FROM Confirmation_letter", (err, result) => {
    res.json({ message: result });
  });
});

router.post("/getNOC", (req, res) => {
  db.query("SELECT *FROM noc_letter", (err, result) => {
    res.json({ message: result });
  });
});

router.post("/getExperienceCertificate", (req, res) => {
  db.query("SELECT *FROM experience_certificate", (err, result) => {
    res.json({ message: result });
  });
});

router.post("/getExperienceCertificateById", (req, res) => {
  const { id } = req.body;
  db.query(
...
router.post("/getappointmentLetterById", (req, res) => {
  const { id } = req.body;
  db.query("SELECT *FROM appointment_letter WHERE id=?", id, (err, result) => {
    res.json({ message: result });
  });
});
router.post("/getNOCById", (req, res) => {
  const { id } = req.body;
  db.query("SELECT *FROM noc_letter WHERE id=?", id, (err, result) => {
    res.json({ message: result });
  });
});
router.post("/getConfirmationLetterById", (req, res) => {
  const { id } = req.body;
...
router.post("/getdepartmentByID", (req, res) => {
  const { id } = req.body;
...
router.post("/getAllDesignation", (req, res) => {
  db.query("SELECT *FROM designation", (err, result) => {
    res.json({ message: result });
  });
});

router.post("/getAllTitle", (req, res) => {
...
router.post("/deleteTitle", (req, res) => {
  const { id } = req.body;
...
router.post("/getdesignationByID", (req, res) => {
  const { id } = req.body;
...
router.post("/addEmployeeAttendancePeriod", (req, res) => {
  const {
    emp_id,
    attendance_inTime,
    attendance_outTime,
...
router.post("/addBulkEmployee", async (req, res) => {
  const { selectedCSVData, session } = req.body;
...
//Bulk Attendance
router.post("/addBulkAttendance", (req, res) => {
...
router.post("/getAttendanceForEmployee", (req, res) => {
...
router.post("/getAttendanceSummaryForAllEmployee", (req, res) => {
  const { empID, startDate, endDate } = req.body;
...
router.post("/getlateEmployeeList", (req, res) => {
...
router.post("/updateovertimeeligibility", (req, res) => {
...
router.post("/getAllAttendanceInOutTimeWithSalary", (req, res) => {
  db.query(
...
router.post("/getAllAttendance", (req, res) => {
...
router.post("/getDailyAttendance", (req, res) => {
...
router.post("/getAllAttendanceByID", (req, res) => {
  const page = parseInt(req.query.page) || 1;
  const pageSize = parseInt(req.query.pageSize) || 20;
  const offset = (page - 1) * pageSize;
...
router.post("/getAllAttendanceDeviceByID", (req, res) => {
  const page = parseInt(req.query.page) || 1;
  const pageSize = parseInt(req.query.pageSize) || 20;
  const offset = (page - 1) * pageSize;
  const { empID, month } = req.body;
...
router.post("/getPrincipleData", (req, res) => {
  db.query(
...
router.post("/getTeacherAllData", (req, res) => {
...
router.post("/getTeacherAllDataByDepartment", (req, res) => {
...
router.post("/getAHODAllDataByDepartment", (req, res) => {
  const { department } = req.body;
...
router.post("/getACCODAllDataBySchool", (req, res) => {
...
router.post("/getTeacherAllDataBySchool", (req, res) => {
  const { school } = req.body;
...
router.post("/getAdminAllData", (req, res) => {
  db.query(
...
router.post("/getEmployeeByID", (req, res) => {
...
router.post("/getEmployeeCount", (req, res) => {
  db.query(
...
router.post("/getEmployeeByidd", (req, res) => {
  const { id } = req.body;
...
router.post("/addRecruitmentApplicant", (req, res) => {
  const {
    adder_id,
    adder_name,
    applicant_name,
...
router.post("/EmployeeAttendancePeriod", (req, res) => {
...
router.post("/getEmployeeAttendancePeriod", (req, res) => {
...
router.post("/DeleteEmployeeAttendancePeriod", (req, res) => {
  const { id } = req.body;
  db.query(
...
router.post("/addTeacherEvaluation", (req, res) => {
  const {
    termName,
    department,
    teacherID,
...
router.post("/getTeacherEvaluation", (req, res) => {
...
router.post("/getAdminEvaluationFormList", (req, res) => {
  const { designation } = req.body;
...
router.post("/getEvaluator", (req, res) => {
  const { designation } = req.body;
  db.query(
...
router.post("/getCompletedEvolutionFor", (req, res) => {
...
router.post("/evaluationQuestionsForm", (req, res) => {
  const {
    ev_ID,
    evaluator,
    department,
...
router.post("/updateEvaluationQuestionsForm", (req, res) => {
  const {
    ev_ID,
    evaluator,
    department,
...
router.post("/evaluationFormStatus", (req, res) => {
...
router.post("/getEvaluationAnswerListByID", (req, res) => {
...
router.post("/evaluationAnsweForm", (req, res) => {
  const {
    ev_ID,
    evaluated_by_ID,
    evaluated_by_Name,
...
router.post("/addadminevaluationForm", (req, res) => {
  const {
    Form_ID,
    Employee_Name,
    Employee_ID,
...
router.post("/updateadminevaluationForm", (req, res) => {
...
router.post("/updatePrincipalApproval", (req, res) => {
...
router.post("/getEvaluationFormList", (req, res) => {
  const { type } = req.body;
  db.query(
    `SELECT
    EQ.*,
...
router.post("/getSalaryByAccount", async (req, res) => {
...
router.post("/getSalaryReportByHR", async (req, res) => {
  const { selectedMonth } = req.body;
...
router.post("/getOverTimeReportByHR", async (req, res) => {
  const { selectedMonth } = req.body;
...
router.post("/fetchPreviousSalaryReportByHR", async (req, res) => {
  const { selectedMonth } = req.body;
...
router.post("/addFinalSalarySheet", (req, res) => {
  const {
    employeeDataList,
    creator_ID,
    creator_Name,
...
router.post("/addSalaryReportByHR", (req, res) => {
  const {
    employeeDataList,
    creator_ID,
    creator_Name,
...
router.post("/addOverTimeReportByHR", (req, res) => {
  const {
    employeeDataList,
    creator_ID,
    creator_Name,
...
router.post("/fetchPreviousOverTimeReportByHR", (req, res) => {
  const { selectedMonth } = req.body;
...
router.post("/addSalaryIncreament", (req, res) => {
  const {
    emp_id,
    emp_name,
    emp_department,
...
router.post("/getAllSalaryHistory", (req, res) => {
  const page = parseInt(req.query.page) || 1;
  const pageSize = parseInt(req.query.pageSize) || 20;
  const offset = (page - 1) * pageSize;
...
router.post("/updateSalaryIncreament", (req, res) => {
...
router.post("/addaitparameter", (req, res) => {
...
router.post("/getaitparameter", (req, res) => {
...
router.post("/addallowance", (req, res) => {
...
router.post("/getallowance", (req, res) => {
...
router.post("/deleteallowance", (req, res) => {
  const { emp_id } = req.body;
...
router.post("/getaitreport", (req, res) => {
  const { session } = req.body;
...
router.post("/addUserIdPrefix", (req, res) => {
  const {
    id_prefix,
    type,
    session,
...
router.post("/getallprefix", (req, res) => {
...
router.post("/generateStudentId", (req, res) => {
...
router.post("/generateEmpId", (req, res) => {
  const { prefix } = req.body;
...
router.post("/deleteUserIdPrefix", (req, res) => {
  const { id } = req.body;
