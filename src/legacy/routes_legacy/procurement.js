...
router.post("/getrequisionItemById", (req, res) => {
...
router.post("/getrequisionItemByIdList", (req, res) => {
  const { requisition_id } = req.body;
  db.query(
...
router.post("/getrequisionItemApprovelChk", (req, res) => {
  const { requisition_id } = req.body;
  db.query(
...
router.post("/DeleteRequisionFullApproved", (req, res) => {
  const { requisition_id } = req.body;
  db.query(
...
router.post("/DeleteRequisionApproval", (req, res) => {
...
router.post("/getrequisionFullApprovedChk", (req, res) => {
  const { requisition_id } = req.body;
  db.query(
...
router.post("/getrequisionApprovedChk", (req, res) => {
  const { requisition_id } = req.body;
  db.query(
...
router.post("/getitemsByCsRequId", (req, res) => {
...
router.post("/getrequisionBycsId", (req, res) => {
...
router.post("/getrequisioncsByID", (req, res) => {
  const { id } = req.body;
...
router.post("/submitrequisionCSRemark", (req, res) => {
...
router.post("/DeleteRequisionItemById", (req, res) => {
  const { id } = req.body;
...
router.post("/getrequisionData", (req, res) => {
  const { user } = req.body;
...
router.post("/getrequisionCSData", (req, res) => {
  db.query("SELECT *FROM requisition_cs ", (err, result) => {
    res.json({ message: result });
  });
});
router.post("/getCSDataById", (req, res) => {
  const { id } = req.body;
  db.query("SELECT *FROM requisition_cs WHERE cs_id=?", id, (err, result) => {
    res.json({ message: result });
  });
});
router.post("/getrequisitionItemId", (req, res) => {
  const { id } = req.body;
...
router.post("/requisitionItemSubmit", (req, res) => {
...
router.post("/requisitionCSitemsubmit", (req, res) => {
  const {
    requisition_id,
    cs_id,
    item_id,
...
router.post("/deleteRequisitionTimeline", (req, res) => {
...
router.post("/UpdaterequisitionCSApproveUpdate", (req, res) => {
...
router.post("/UpdaterequisitionItemUpdate", (req, res) => {
...
router.post("/UpdateStoreRequisitionItemUpdate", (req, res) => {
...
router.post("/StoreSubmit", (req, res) => {
  const { requisition_id, note } = req.body;
...
router.post("/removePermission", (req, res) => {
...
//unused
router.post("/managersubmit", (req, res) => {
...
router.post("/requisitionStatus", (req, res) => {
...
router.post("/requisitionApproveCHP", (req, res) => {
...
router.post("/UpdaterequisitionApprovelUpdate", (req, res) => {
...
router.post("/requisitionSubmit", (req, res) => {
  const {
    name,
    session,
    requisition_id,
...
//supplier
router.post("/supplierSubmit", (req, res) => {
...
router.post("/getsupplierByID", (req, res) => {
  const { id } = req.body;
...
router.post("/UpdateSupplierByID", (req, res) => {
...
router.post("/UpdateApprovelPO", (req, res) => {
...
router.post("/UpdateApprovelforPrincipal", (req, res) => {
...
router.post("/PoItemSubmit", (req, res) => {
  const {
    po_id,
    cs_id,
    req_id,
...
router.post("/getpolist", (req, res) => {
  db.query("SELECT *FROM po", (err, result) => {
    res.json({ message: result });
  });
});

router.post("/getpoItemallinfo", (req, res) => {
  const { po_id } = req.body;
...
//fr
router.post("/addFundRequest", (req, res) => {
...
router.post("/getFundRequest", (req, res) => {
  db.query("SELECT *FROM fund_request", (err, result) => {
    res.json({ message: result });
  });
});

router.post("/getFundRequestById", (req, res) => {
  const { id } = req.body;
...
router.post("/UpdateFundRequestApprovel", (req, res) => {
...
router.post("/UpdateSPApprovel", (req, res) => {
  const { id, user, status } = req.body;
...
router.post("/UpdateFundRequest", (req, res) => {
...
//fr
//sp item
router.post("/addSupplyPaymentItem", (req, res) => {
...
router.post("/getSupplyPaymentItem", (req, res) => {
  db.query("SELECT *FROM fp_sp_item", (err, result) => {
    res.json({ message: result });
  });
});

router.post("/getSupplyPaymentItemById", (req, res) => {
...
router.post("/getfundrequestInfo", (req, res) => {
...
router.get("/procurementTest", (req, res) => {
