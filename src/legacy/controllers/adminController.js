...
exports.deleteAcadEvent_event_ID = (req, res) => {
...
// Get All Events
exports.getAcademicEvent = (req, res) => {
...
// update a New Event
exports.edittasks_task_ID = async (req, res) => {
...
exports.tasks_taskID_username = (req, res) => {
...
exports.comments_taskID_isComment = (req, res) => {
...
exports.editnote_stickyID_ = (req, res) => {
...
exports.taskstatus_taskID_userName = (req, res) => {
  const { taskID, userName } = req.params;
...
exports.users_userName = (req, res) => {
...
exports.tasks_userName = (req, res) => {
  const { userName } = req.params;
...
exports.stickynotes_userName = (req, res) => {
  const { userName } = req.params;
...
exports.singletask_taskID_userName = (req, res) => {
  const { taskID, userName } = req.params;
...
exports.guests_task_ID = (req, res) => {
  const { task_ID } = req.params;
...
exports.comments_taskID = (req, res) => {
...
exports.getEventsInfoById = (req, res) => {
...
exports.getEventsTaskById = (req, res) => {
  const { id } = req.body;
...
exports.UpdateEventsTask = (req, res) => {
...
exports.getDailyTaskUser = (req, res) => {
...
exports.getDailyTaskAllUser = (req, res) => {
...
exports.getDailyTaskByDate = (req, res) => {
  const { date } = req.body;
  db.query(
...
exports.UpdateDailyTaskStatus = (req, res) => {
...
exports.AssignRouteEmployee = (req, res) => {
...
exports.geAssignRouteEmployee = (req, res) => {
  db.query(
...
exports.getApproveCount = (req, res) => {
  db.query(
    `
