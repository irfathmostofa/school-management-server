...
exports.postHifzDailyProgress = (req, res) => {
  const {
    student_id,
    campus,
    session,
...
exports.updateHifzDailyProgress = (req, res) => {
  const {
    student_id,
    campus,
    session,
...
exports.getHifzDailyProgressByStudentId = (req, res) => {
...
exports.getHifzDailyProgressByStudentIdMonth = (req, res) => {
...
exports.getHifzDailyProgress = (req, res) => {
...
exports.getHifzDailyProgressInDate = (req, res) => {
...
exports.deleteHifzDailyProgress = (req, res) => {
  const { id } = req.body;
  db.query(
...
// HifzTermTargetSetup
exports.postHifzTermTargetSetup = (req, res) => {
...
exports.updateHifzTermTargetSetup = (req, res) => {
  const { student_id, campus, session, halakah, term, type, month, lesson } =
    req.body;
...
exports.getHifzTermTargetSetup = (req, res) => {
...
exports.getHifzTermTargetSetupMonth = (req, res) => {
...
exports.getHifzSprhalaka = (req, res) => {
...
exports.deleteHifzTermTargetSetup = (req, res) => {
  const { id } = req.body;
  db.query(
...
exports.getHifzSprTargetByStudentId = (req, res) => {
...
// HifzTermTargetSetup
exports.postIncidentReport = async (req, res) => {
  const {
    student_id,
    submitDate,
    dateOfOccurrence,
...
exports.getIncidentReport = (req, res) => {
...
exports.deleteIncidentReport = (req, res) => {
  const { id } = req.body;
...
exports.getHifzSprHalakahStudents = (req, res) => {
...
exports.getSoldFormForDashboard = (req, res) => {
...
exports.getAdmissionForDashboard = (req, res) => {
...
exports.deleteSoldForm = (req, res) => {
...
exports.getadmissioninfo = (req, res) => {
  db.query("SELECT *FROM online_admission", (err, result) => {
    res.json({ message: result });
  });
}

exports.getAllSiblingData = (req, res) => {
  db.query(
...
exports.getSiblingData = (req, res) => {
...
exports.fetchApplicants = (req, res) => {
...
exports.fetchApplicantsAlldata = (req, res) => {
...
exports.fetchApplicantsAdmissionTest = (req, res) => {
  db.query("SELECT *FROM admission WHERE eligible_status=''", (err, result) => {
    res.json({ message: result });
  });
}

exports.fetchApplicantsAdmitCard = (req, res) => {
...
exports.generateAdmissionAdmitCard = (req, res) => {
  const { form_number } = req.body;
...
exports.fetchApplicantsbyID = (req, res) => {
  const { id } = req.body;
  db.query(
...
exports.fetchApplicantsbyFormNo = (req, res) => {
  const { form_number } = req.body;
  db.query(
...
exports.fetchAllAdmittedStudents = (req, res) => {
  db.query(
...
exports.fetchAdmittedStudentsForFeesForward = (req, res) => {
...
exports.fetchAdmittedStudents = (req, res) => {
  const {
    Class,
    section,
    session,
...
exports.fetchNotEnrolledStudents = (req, res) => {
  const {
    Class,
    section,
    session,
...
exports.fetchEligibleStudents = (req, res) => {
...
exports.getAdmittedlaststudent = (req, res) => {
  db.query(
...
exports.post_getSiblingData = (req, res) => {
  const { student_id, session } = req.body;
  db.query(
    "SELECT *FROM student WHERE student_id = ? AND session = ?",
    [student_id, session],
...
exports.UpdateStudentAid = (req, res) => {
  const {
    id,
    admission_discount,
    admission_amount,
...
exports.admissionformsubmit = async (req, res) => {
  const {
    session,
    form_number,
    campus,
...
exports.admissionformUpdate = (req, res) => {
...
exports.updateAdmissionPrincipalApprove = (req, res) => {
...
exports.updateadmissionform = (req, res) => {
  const {
    id,
    form_number,
    submission_date,
...
exports.admissiontestresult = (req, res) => {
  const {
    session,
    test_date,
    form_number,
...
exports.getAdmissionTestResult = (req, res) => {
  db.query(`
    SELECT 
      at.*,
      a.gender,
...
exports.getAdmissionTestResultEligible = (req, res) => {
...
//   });
// });
exports.getAdmissionTestResultByid = (req, res) => {
  const { id } = req.body;
...
exports.deleteAdmissionTestResultByid = (req, res) => {
  const { id } = req.body;
  db.query("DELETE FROM admission_test WHERE id = ?", id, (err, result) => {
    res.json({ message: true });
  });
}
exports.getApplientViewByid = (req, res) => {
  const { id } = req.body;
...
exports.getApprovedHouse = (req, res) => {
  db.query("SELECT *FROM house WHERE pstatus=1", (err, result) => {
    res.json({ message: result });
  });
}
exports.getHouseforapprovel = (req, res) => {
...
exports.approveHouseById = (req, res) => {
...
exports.getCategoryforprincipal = (req, res) => {
...
exports.CategoryApprove = (req, res) => {
  const { id, status } = req.body;
  db.query(
    "UPDATE student_category SET ? WHERE id = ?",
    [{ pstatus: status }, id],
...
exports.getEligiblestudent = (req, res) => {
...
exports.getPendingStudent = (req, res) => {
...
exports.HifzSprApprove = (req, res) => {
...
exports.addHifzSprStudent = (req, res) => {
  const {
    halaqaNumber,
    student_name,
    student_id,
...
exports.transferHalakahStudents = (req, res) => {
...
exports.getHifzSPRStudent = (req, res) => {
  const { session, campus } = req.body;
  db.query(
...
exports.HifzSprStudentApprove = (req, res) => {
  const { id, status, note } = req.body;
  db.query(
...
exports.HifzSprStudentStatus = (req, res) => {
  const { id, status} = req.body;
  db.query(
...
exports.addHifzStudent = (req, res) => {
...
exports.deleteStudentClub = (req, res) => {
  const { id } = req.body;
  db.query(
...
exports.getStudentHifz = (req, res) => {
  db.query("SELECT *FROM hifz_student", (err, result) => {
    res.json({ message: result });
  });
}
exports.deleteHifzStudent = (req, res) => {
  const { id } = req.body;
  db.query(
...
exports.getStudentHifzApprovel = (req, res) => {
  db.query("SELECT *FROM hifz_student WHERE pstatus=''", (err, result) => {
    res.json({ message: result });
  });
}

exports.StudentHifzApprove = (req, res) => {
  const { id, status, note } = req.body;
  db.query(
...
exports.getStudentViewByid = (req, res) => {
...
exports.getStudentViewByidAdmincard = (req, res) => {
  const { id } = req.body;
...
exports.getStudentForPrincipalAprrovel = (req, res) => {
  db.query(
...
exports.ApprovePrincipalApproveStudent = (req, res) => {
...
exports.getStudentIDCardViewByid = (req, res) => {
...
exports.getEligibleStudentIDCardViewByid = (req, res) => {
  const { student_id } = req.body;
...
exports.getEligibleStudentViewByid = (req, res) => {
  const { id } = req.body;
  db.query(
...
exports.getAllEligibleStudent = (req, res) => {
  db.query(
    "SELECT *FROM student WHERE id = ? AND eligible=1",
    id,
    (err, result) => {
...
exports.getClubApprovel = (req, res) => {
  db.query("SELECT *FROM club WHERE status=''", (err, result) => {
    res.json({ message: result });
  });
}

exports.approveClubById = (req, res) => {
  const { id, status } = req.body;
  db.query(
...
exports.addStudentClub = (req, res) => {
...
exports.getStudentClub = (req, res) => {
  const query = `
    SELECT 
      h.*, 
      sa.*
...
exports.fetchStudentBySTid = (req, res) => {
  const { student_id } = req.body;
  db.query(
    "SELECT *FROM student WHERE student_id = ?",
    student_id,
...
//exam
exports.deleteAdmitCard = (req, res) => {
     const { student_id } = req.body;
...
exports.addEligibleStudentForExam = (req, res) => {
...
exports.gettmpPassdata = (req, res) => {
  db.query("SELECT *FROM temporary_pass", (err, result) => {
    res.json({ message: result });
  });
}

exports.gettmpPassdataforApprovel = (req, res) => {
  db.query("SELECT *FROM temporary_pass WHERE status=''", (err, result) => {
    res.json({ message: result });
  });
}

exports.UpdatetmpPassdataApprovel = (req, res) => {
  const { id, status, note } = req.body;
  db.query(
...
exports.gettmpPassByID = (req, res) => {
  const { student_id } = req.body;
  db.query(
...
//   );
// });
exports.TCprincipalApprove = (req, res) => {
  const { id } = req.body;
...
exports.TCreturnStudent = (req, res) => {
  const { id } = req.body;
