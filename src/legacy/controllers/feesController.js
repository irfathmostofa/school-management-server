...
exports.send_due_report_sms = async (req, res) => {
...
exports.addFeesCollection = (req, res) => {
  const {
    student_id,
    fees_info,
    feesType,
...
exports.addFeesCollectionForward = async (req, res) => {
  const {
    student_id,
    fees_info,
    feesType,
...
exports.addStudentExtraFacility = async (req, res) => {
  const {
    student_id,
    facility_1,
    facility_2,
...
exports.UpdateStudentExtraFacility = async (req, res) => {
  const {
    student_id,
    facility_1,
    facility_2,
...
exports.fetchExtraFeeList = (req, res) => {
  const {
    Class,
    session,
    campus,
...
exports.getStudentExtraFacility = (req, res) => {
...
exports.fetchExtraFeeInfoApprovel = (req, res) => {
...
exports.UpdateExtraFeeInfoApprovel = (req, res) => {
...
exports.feesCollectionById = (req, res) => {
  const { student_id } = req.body;
  const query = `
    SELECT 
      fc.*, 
...
exports.getAllCollectedfees = (req, res) => {
...
exports.getAllfeesCollectioninfoWithStudent = (req, res) => {
...
exports.getAllfeesCollectioninfo = (req, res) => {
...
exports.feesCollectionApproval = (req, res) => {
  const sql = `
    SELECT 
      s.student_id,
      s.student_first_name,
...
exports.feesCollectionDueBalance = (req, res) => {
...
exports.getAdvanceFeesStatus = (req, res) => {
  const { student_id } = req.body;
  db.query(
...
// Endpoint 1
exports.updateFeesCollection = (req, res) => {
  const {
    id,
    payment_mode,
    payment_date,
...
exports.updateFeesCollectionNew = (req, res) => {
  const {
    ids, 
    studentId,
    payment_mode,
...
exports.updateFeesCollectionSingle = (req, res) => {
  const {
    id,
    studentId,
    payment_mode,
...
exports.approveFeesCollection = (req, res) => {
  const { id } = req.body;
  db.query(
    "UPDATE fees_collection SET ? WHERE id = ?",
    [{ status2: 0 }, id],
...
exports.deleteFeesCollection = (req, res) => {
   const { id } = req.body;
...
//   });
// });
exports.deleteCollectedFees = (req, res) => {
  const { payment_id } = req.body;
...
exports.approveSingleFeesCollection = (req, res) => {
...
exports.UpdateFeeTypeById = (req, res) => {
...
exports.ApprovedFeeTypeById = (req, res) => {
  const { id, status } = req.body;
  db.query(
    "UPDATE feesType SET ? WHERE id = ?",
    [{ pstatus: status }, id],
...
exports.paymentRepicts = (req, res) => {
  const { student_id, start_date, end_date } = req.body;
  const currentDate = new Date().toISOString().split("T")[0];
  const start = start_date || currentDate;
  const end = end_date || currentDate;
...
exports.v1_getFeeInfo = async (req, res) => {
...
exports.v1_payment = async (req, res) => {
  const {
    userId,
    iid,
    invoiceNo,
...
exports.fetchFeeTypes = (req, res) => {
  db.query("SELECT *FROM feesType", (err, result) => {
    res.json({ message: result });
  });
}
exports.fetchFeeTypesforApprovel = (req, res) => {
  db.query("SELECT *FROM feesType WHERE pstatus=''", (err, result) => {
    res.json({ message: result });
  });
}

exports.fetchFeeTypesById = (req, res) => {
  const { id } = req.body;
...
// Deleting a fee type
exports.deleteFeeTypes = (req, res) => {
  const { id } = req.body;
...
exports.deleteExtraFeeInfo = (req, res) => {
  const { id } = req.body;
...
exports.deleteExtraFeeInfoList = (req, res) => {
  const { id } = req.body;
...
exports.deleteDiscountType = (req, res) => {
  const { id } = req.body;
...
exports.fetchExtraFeeInfo = (req, res) => {
    const { campus } = req.body;
...
exports.UpdateExtraFeeInfo = (req, res) => {
...
exports.fetchFeeInfoApprovel = (req, res) => {
  db.query("SELECT *FROM feeInfo WHERE pstatus=''", (err, result) => {
    res.json({ message: result });
  });
}

exports.UpdateFeeInfoApprovel = (req, res) => {
...
exports.fetchFeeInfoById = (req, res) => {
  const { id } = req.body;
...
exports.addExtraFeeInfo = (req, res) => {
  const {
    facility_name,
    facility_fee,
    recurring,
...
exports.fetchFeeInfoByName = (req, res) => {
  const { feeType } = req.body;
...
exports.addDiscountType = (req, res) => {
...
exports.UpdateDiscountType = (req, res) => {
...
exports.getDiscountType = (req, res) => {
  db.query("SELECT *FROM discount_type ", (err, result) => {
    res.json({ message: result });
  });
}

exports.getDiscountTypeById = (req, res) => {
  const { id } = req.body;
...
exports.addDiscountStudent = (req, res) => {
  const {
    student_id,
    discountType,
    discount,
...
exports.getDiscountDataByStudentId = (req, res) => {
  const { student_id } = req.body;
  db.query(
...
exports.assignDiscount = (req, res) => {
  const {
    student_id,
    Class,
    section,
...
exports.getassignDiscount = (req, res) => {
  db.query("SELECT *FROM assign_discount", (err, result) => {
    res.json({ message: result });
  });
}

exports.getassignDiscountApprove = (req, res) => {
  db.query("SELECT *FROM assign_discount WHERE status=''", (err, result) => {
    res.json({ message: result });
  });
}

exports.UpdateAssignDiscountApprove = (req, res) => {
  const { id, status, note } = req.body;
  db.query(
...
exports.getassignDiscountforUpdate = (req, res) => {
...
exports.getassignDiscounttById = (req, res) => {
  const { id } = req.body;
...
exports.getassignDiscounttByStudentId = (req, res) => {
  const { student_id } = req.body;
  db.query(
...
exports.getAllStudentDiscount = (req, res) => {
...
exports.deleteAssignDiscount = (req, res) => {
   const { id } = req.body;
...
exports.UpdateAssignDiscount = (req, res) => {
  const {
    id,
    student_id,
    discount_type,
...
exports.student_fees_due_report = (req, res) => {
...
exports.getStudentDueBalance = (req, res) => {
  const { student_id } = req.body;
...
exports.manualClassFeesForward = async (req, res) => {
  if (isClassFeeForwardRunning) {
    return res.json({
      success: false,
