...
exports.addRecruitmentRequest = (req, res) => {
  const {
    requester_name,
...
exports.changeRecruitmentRequestStatus = (req, res) => {
...
exports.changeEvolutionQA = (req, res) => {
...
exports.changeTeacherInterviewData = (req, res) => {
...
exports.changeRecruitmentApplicantStatus = (req, res) => {
  const { status, id } = req.body;
...
exports.changeRecruitmentApplicantEvolutor = (req, res) => {
...
exports.changeRecruitmentApplicantFeedback = (req, res) => {
...
exports.getAllRecruitmentRequest = (req, res) => {
...
exports.getAllEvolutorData = (req, res) => {
  const page = parseInt(req.query.page) || 1;
  const pageSize = parseInt(req.query.pageSize) || 9999;
  const offset = (page - 1) * pageSize;
...
exports.getAllRecruitmentApplicantList = (req, res) => {
  const page = parseInt(req.query.page) || 1;
  const pageSize = parseInt(req.query.pageSize) || 9999;
  const offset = (page - 1) * pageSize;
...
exports.getAllRecruitmentApplicantListByID = (req, res) => {
...
exports.changeLeaveCheckIn = (req, res) => {
  const { id } = req.body;
...
exports.getApprovingAuthority = async (req, res) => {
...
exports.changeLeaveApplicationStatus = (req, res) => {
...
exports.changeResignationApplicationStatus = (req, res) => {
  const { id, cldata, valueData } = req.body;
...
exports.getAllResignRequest = (req, res) => {
...
exports.getRegisnationApprovingAuthority = async (req, res) => {
...
exports.getResignationById = (req, res) => {
...
exports.deleteResignation = (req, res) => {
  const { applicantIdNo } = req.body;
...
exports.createClearanceForm = (req, res) => {
  const {
    emp_id,
    emp_name,
    emp_designation,
...
exports.getClearanceFormList = (req, res) => {
  const page = parseInt(req.query.page) || 1;
  const pageSize = parseInt(req.query.pageSize) || 9999;
  const offset = (page - 1) * pageSize;
...
exports.updateClearanceForm = (req, res) => {
  const {
    id,
    columnDes,
    columnDesValue,
...
exports.uploadClearanceScanCopy = (req, res) => {
  const { id } = req.body;
...
exports.getClearanceEmployee = (req, res) => {
  db.query(
    `
    SELECT 
    employee.*, 
...
exports.addCompensationBenefits = (req, res) => {
  const {
    emp_id,
    emp_name,
    designation,
...
exports.getCompensationBenefitsList = (req, res) => {
  const page = parseInt(req.query.page) || 1;
  const pageSize = parseInt(req.query.pageSize) || 9999;
  const offset = (page - 1) * pageSize;
...
exports.getOtherLeaveById = (req, res) => {
  const { id } = req.body;
...
exports.EditOtherLeaveById = (req, res) => {
  const { id } = req.body;
...
exports.DeleteOtherLeaveById = (req, res) => {
  const { id } = req.body;
...
exports.UpdateOtherLeaveById = (req, res) => {
...
exports.ApprovelOtherLeaveById = (req, res) => {
...
exports.updateEmployeeAttendancePeriod = (req, res) => {
  const {
    emp_id,
    attendance_inTime,
    attendance_outTime,
...
exports.editEmployeeAttendancePeriod = (req, res) => {
...
exports.addExitApplicationForm = (req, res) => {
  const {
    id,
    emp_id,
    exitDate,
...
exports.getExitApplicationForm = (req, res) => {
  db.query(
...
exports.getExitApplicationFormById = (req, res) => {
  const { emp_id } = req.body;
  db.query(
...
//update student
exports.getStudentViewByStId = (req, res) => {
...
exports.updateAmissionStudentImagesById = (req, res) => {
...
exports.updateStudentImagesById = (req, res) => {
