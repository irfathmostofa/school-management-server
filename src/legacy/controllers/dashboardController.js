...
exports.getDashboardMonthlyFeesData = (req, res) => {
...
exports.getDashboardLeaveRequest = (req, res) => {
...
exports.getDashboardExpenseData = (req, res) => {
  const { type } = req.body;
...
exports.getDashboardUnPaidFeesData = (req, res) => {
...
exports.getDashboardEventNews = (req, res) => {
...
exports.dashboardStatForEmployee = async (req, res) => {
  const { campus } = req.body; 
...
exports.dashboardStatForStudents = async (req, res) => {
  const { session, campus } = req.body;
...
exports.sidebarBadgeCount = async (req, res) => {
...
exports.DailyAttendanceInfo = (req, res) => {
  const { campus } = req.body;
...
exports.DailyAttendanceForClassSection = (req, res) => {
  const { campus } = req.body;
...
exports.DailyLessonPlanForClassSection = (req, res) => {
...
exports.DailyClassTestForClassSection = (req, res) => {
...
exports.DailyHomeworkForClassSection = (req, res) => {
    const {session } = req.body;
