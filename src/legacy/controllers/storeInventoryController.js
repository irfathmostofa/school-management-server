...
exports.getProductTypeinduById = (req, res) => {
  const { id } = req.body;
...
exports.getProductLastID = (req, res) => {
  const { cat } = req.body;
  db.query(
...
exports.getStudentProducts = (req, res) => {
...
exports.addTransferProduct = (req, res) => {
  const {
    product_id,
    product_name,
    transferCampus,
...
exports.updateTransferProduct = (req, res) => {
...
exports.updateTransferHistory = (req, res) => {
...
exports.getLibraryItemByID = (req, res) => {
...
exports.getLibraryIssuedItems = (req, res) => {
...
exports.addLibraryIssueItems = async (req, res) => {
  const {
    receiver_id,
    receiver_name,
    receiver_type,
...
exports.getLibraryReturnItems = (req, res) => {
...
exports.addLibraryReturnItems = async (req, res) => {
  const {
    giver_id,
    giver_name,
    giver_type,
...
exports.getGRNinfo = (req, res) => {
  db.query("SELECT *FROM grn ORDER BY id DESC", (err, result) => {
    res.json({ message: result });
  });
}

exports.getAllinfoByGRN = (req, res) => {
...
exports.updateGRNBillstatus = (req, res) => {
...
exports.updateMDRstatus = (req, res) => {
...
exports.getAllMDRinfoByID = (req, res) => {
...
exports.getAllSearchCustomer = (req, res) => {
...
exports.getLastQuotationId = (req, res) => {
  db.query(
...
exports.getquotationItemById = (req, res) => {
...
exports.getLastPurchaseId = (req, res) => {
  db.query(
...
exports.addStoreProduct = (req, res) => {
  const {
    session,
    customer_name,
    total,
...
exports.getLastStoreProductId = (req, res) => {
  db.query(
    "SELECT product_id FROM store_product ORDER BY id DESC LIMIT 1",
    (err, result) => {
      if (err) {
...
exports.getallStoreProduct = (req, res) => {
  const query = `
    SELECT 
      q.*,
      COALESCE(SUM(qi.qty), 0) AS total_qty,
...
exports.getallStoreProductItemlist = (req, res) => {
...
exports.getStoreProductItemById = (req, res) => {
...
exports.getallbillinfo = (req, res) => {
